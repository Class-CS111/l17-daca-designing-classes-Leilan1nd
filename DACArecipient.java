...
public class DACArecipient
{
  ...
  /**DESCRIPTION: Assigns parameters to corresponding instance variables of calling DACArecipient. */
	...
	/**DESCRIPTION: Creates a string of all the calling DACArecipient's instance variables
	 */
 ...
 /*DESCRIPTION: compares the instance variables of the calling DACArecipient w/ those of the parameter.
  * If all are equal then returns true, otherwise return false
  */
